...
add_theme_support( 'list-thumbnail' );
set_post_thumbnail_size( 640, 480, array( 'top', 'center') );
add_theme_support( 'small-thumbnail' );
set_post_thumbnail_size( 320, 240, array( 'top', 'center') );